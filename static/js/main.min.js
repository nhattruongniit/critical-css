...
function initializeClock(endtime,clock){var days=clock.querySelector('.js-clock__days');var hours=clock.querySelector('.js-clock__hours');var mins=clock.querySelector('.js-clock__mins');var secs=clock.querySelector('.js-clock__secs');function updateClock(){var t=getTimeRemaining(endtime);days.innerHTML=t.days;hours.innerHTML=('0'+t.hours).slice(-2);mins.innerHTML=('0'+t.minutes).slice(-2);secs.innerHTML=('0'+t.seconds).slice(-2);if(t.total<=0){clearInterval(timeinterval)}}
updateClock();var timeinterval=setInterval(updateClock,1000)}
if($('.js-clock')){var deadline=new Date(Date.parse(new Date())+15*24*60*60*1000);$('.js-clock').each(function(index,el){initializeClock(deadline,el)})}
$('.js-filter > a').on('click',function(){var $filter=$(this).attr('data-filter');$('.js-filter a').removeClass('active');$(this).addClass('active');$(this).parents('.c-yield__stage').find($('.c-yield__public')).hide().removeClass('active');$('.'+$filter).show().addClass('active')})
$('.js-filterFeature > a').on('click',function(){var $filter=$(this).attr('data-filter');$('.js-filterFeature a').removeClass('active');$(this).addClass('active');$(this).parents('.c-yield__stageFeature').find($('.c-yield__public')).hide().removeClass('active');$('.'+$filter).show().addClass('active')})})